...
main = do
    spawn "sh /home/$USER/shFiles/.fehbg"
    ...
    --spawn "deluge"
    --spawn "finch"
    spawn "sh /home/$USER/shFiles/switchToDefault"
    spawn "xflux -l 33.55, 44.55"
    
    xmproc <- spawnPipe "/usr/bin/xmobar /home/$USER/.xmonad/xmobar/.xmobarrc"
...
--             , ppTitle           = xmobarColor currentColor "" . wrap "[" "]" . shorten 70
        ...
        , ((mod1Mask, xK_F4), kill)
        , ((mod4Mask .|. shiftMask, xK_d), spawn "nautilus /home/$USER/Transferências")
        , ((mod4Mask .|. shiftMask, xK_f), spawn "nautilus /home/$USER/Fac")
        , ((mod4Mask .|. shiftMask, xK_v), spawn "nautilus /home/$USER")
    --    , ((mod4Mask .|. shiftMask, xK_v), spawn "thunar /home/$USER/Transferências")
        , ((mod4Mask .|. shiftMask, xK_r), spawn "nautilus /run/media/$USER/C*/")
        ...
        , ((mod4Mask .|. shiftMask, xK_F2), spawn "pkill -u $USER")
